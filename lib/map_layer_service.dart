...
class MapLayerService {
  ...
  static const Map<String, dynamic> _buildingLabelsData = {
    ...
    'features': [
      ...
      {'type': 'Feature', 'properties': {'name': 'Hemlock Suites'}, 'geometry': {'type': 'Point', 'coordinates': [-75.170952678369, 40.99810844403229]}},
      {'type': 'Feature', 'properties': {'name': 'Lenape Residence Hall'}, 'geometry': {'type': 'Point', 'coordinates': [-75.1720, 40.9986]}},
      {'type': 'Feature', 'properties': {'name': 'Hawthorn Suites'}, 'geometry': {'type': 'Point', 'coordinates': [-75.17221480399249, 40.999008083225235]}},
      {'type': 'Feature', 'properties': {'name': 'Sycamore Suites'}, 'geometry': {'type': 'Point', 'coordinates': [-75.17258710341217, 40.99726055506236]}},
      ...
      {'type': 'Feature', 'properties': {'name': 'Rosenkrans'}, 'geometry': {'type': 'Point', 'coordinates': [-75.1746005852608, 40.99475853188691]}},
      {'type': 'Feature', 'properties': {'name': 'DeNike'}, 'geometry': {'type': 'Point', 'coordinates': [-75.17602, 40.994049]}},
      {'type': 'Feature', 'properties': {'name': 'Innovation Center'}, 'geometry': {'type': 'Point', 'coordinates': [-75.1547531531174, 41.00191971253376]}},
